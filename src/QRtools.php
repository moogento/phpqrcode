...
class QRtools {
    ...
    public static function timeBenchmark()
    {
        ...
        foreach($GLOBALS['qr_time_bench'] as $markerId=>$thisTime) {
            if ($p > 0) {
                echo '<tr><th style="text-align:right">till '.$markerId.': </th><td>'.number_format((float)$thisTime-$lastTime, 6).'s</td></tr>';
            } else {
                $startTime = $thisTime;
            }
        ...
        echo '</tbody><tfoot>
            <tr style="border-top:2px solid black"><th style="text-align:right">TOTAL: </th><td>'.number_format((float)$lastTime-$startTime, 6).'s</td></tr>
        </tfoot>
        </table>';
    }
